...
export class Apif29BioService {
    ...
    getSymptomsOfDisease(lang,listIds,depth){
        return this.http.post(environment.urlDxv2+'/api/v1/F29Bio/disease/phenotypes/'+lang, listIds).pipe(
              map((res: any) => {
                return res;
            }),
    ...
    callTAFhir(textf){
        return this.http.post(environment.api+'/api/callTAFhir', textf).pipe(
          map((res: any) => {
            return res;
        }),
          catchError((err) => { console.log(err);
    ...
    getSegmentation(lang,textf){
        return this.http.post(environment.f29bio+'/api/Translation/document/segmentation?lan='+lang, textf).pipe(
          map((res: any) => {
            return res;
        }),
          catchError((err) => { console.log(err);
    ...
    getTranslationDictionary(lang,segments){
      var body = {lang:lang, segments: segments}
        return this.http.post(environment.api+'/api/Translation/document/translate', body).pipe(
          map((res: any) => {
            return res;
        }),
          catchError((err) => { console.log(err);
    ...
    getSuccessorsOfSymptoms(listOfSymptoms){
        return this.http.post(environment.f29bio+'/api/BioEntity/phenotype/successors/',listOfSymptoms).pipe(
          map((res: any) => {
            return res;
        }),
          catchError((err) => { console.log(err);
    ...
    getLeavesOfSymptoms(listOfSymptoms){
        return this.http.post(environment.f29bio+'/api/BioEntity/phenotype/leaves/',listOfSymptoms).pipe(
          map((res: any) => {
            return res;
        }),
          catchError((err) => { console.log(err);
